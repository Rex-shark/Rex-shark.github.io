      ...
      <main className="pt-14 relative z-10">
        ...
        <section id="about" className="max-w-5xl mx-auto px-6 py-24 flex flex-col md:flex-row items-center gap-12 relative">
          ...
          >
            ...
            <div
              className="text-lg leading-relaxed max-w-md mb-8 space-y-2"
        ...
        <section id="skills" className="max-w-5xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
            {skillGroups.map((group, i) => (
              <motion.div
                key={group.key}
                className={group.key === AI_KEY ? 'p-5 rounded-xl sm:col-span-2' : 'p-5 rounded-xl'}
                style={{
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {projects.map((project, i) => (
              <motion.div
                ...
                className="relative h-full p-6 rounded-2xl cursor-pointer transition-all duration-300"
                style={{
              ...
              >
                <div className="flex items-start justify-between gap-3 mb-3">
                  ...
                  <a
                    ...
                    style={{ color: 'rgba(185,103,255,0.6)' }}
                  >
                    <GithubIcon size={14} />
                  </a>
                </div>
